        ...
        x86_64)
            if [ ! -d $OPT/$ARM_ROOT ]; then
                (
                    ...
                    sudo wget --progress=dot:giga --no-check-certificate https://firmware.ardupilot.org/Tools/STM32-tools/gcc-arm-none-eabi-10-2020-q4-major-x86_64-linux.tar.bz2
                    echo "Installing..."
